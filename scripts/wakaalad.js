        ...
        success: function(data) {
            ...
            if (status == true) {
                ...
                message.forEach(function(item, i) {
                    ...
                    $("#provider").val(item['Provider']);
                    $("#Phone").val(item['Phone']);
                    $("#des").val(item['Description']);
                    $("#receive").val(item['Receiving']);
...
function delete_owner(custo_id) {
    ...
    $.ajax({
        method: "POST",
        url: "../apis/wakaalad.php",
        data: { "action": "delete_wakaalad", "custo_id": custo_id },
        dataType: "JSON",
        async: true,
        success: function(data) {
            var status = data.status;
