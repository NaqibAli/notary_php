...
function insert($conn)
{
    ...
    $query = "CALL customer_sp('','$name','$mother','$place','$dob','$address','$identity','$phone','$date','$userId','Insert')";
...
function update($conn)
{
    ...
    $data = [];
    $name = $conn->real_escape_string($name);
    $query = "CALL customer_sp('$id','$name','$mother','$place','$dob','$address','$identity','$phone','$date','$userId','Update')";
    $result = $conn->query($query);
